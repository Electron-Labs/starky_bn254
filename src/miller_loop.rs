...
//     const D: usize,
//     const C: usize,
// >(trace: &mut Vec<[F; C]>, x: &Fp, y: &Fp, ell_coeffs: &[[Fp2; 3]], start_row: usize, end_row: usize, start_col: usize) {
...
//             for k in 0..3 {
//                 assign_u32_in_series(trace, row, start_col + ELL_COEFFS_OFFSET + k*24, &ell_coeffs[j][k].get_u32_slice().concat());
//             }
//             assign_u32_in_series(trace, row, start_col + F12_OFFSET, &f12.get_u32_slice().concat());
//         }
//         if j != 0 {
...
//     f12 = f12.conjugate();
//     for row in start_row..end_row+1 {
//         assign_u32_in_series(trace, row, start_col + MILLER_LOOP_RES_OFFSET, &f12.get_u32_slice().concat());
//     }
//     for row in start_row..end_row+1 {
//         fill_trace_negate_fp6(trace, &Fp6(f12.0[6..].try_into().unwrap()), row, start_col + RES_CONJUGATE_OFFSET);
//     }
//     // assert_eq!(i, 0);
// }
...
//     pub fn generate_trace(&self, x: Fp, y: Fp, ell_coeffs: Vec<[Fp2; 3]>) -> Vec<[F; TOTAL_COLUMNS]> {
...
//     for i in 0..12 {
//         yield_constr.constraint_transition(local_values[start_col + PX_OFFSET + i] - next_values[start_col + PX_OFFSET + i]);
//         yield_constr.constraint_transition(local_values[start_col + PY_OFFSET + i] - next_values[start_col + PY_OFFSET + i]);
//     }
//     for i in 0..24*3*2 {
//         if i==0 {
//             yield_constr.constraint(local_values[start_col + FIRST_BIT_SELECTOR_OFFSET] * (local_values[start_col + F12_OFFSET + i] - P::ONES));
//         } else {
//             yield_constr.constraint(local_values[start_col + FIRST_BIT_SELECTOR_OFFSET] * local_values[start_col + F12_OFFSET + i]);
//         }
//     }
...
//                 local_values[start_col + F12_MUL_BY_014_OFFSET + MULTIPLY_BY_014_X_CALC_OFFSET + FP6_ADDITION_TOTAL + (FP_SINGLE_REDUCE_TOTAL + RANGE_CHECK_TOTAL)*j + FP_SINGLE_REDUCED_OFFSET + i])
//             );
//             yield_constr.constraint(
//             bit_selector_val *
//                 next_values[start_col + FIRST_ROW_SELECTOR_OFFSET] *
...
//                 local_values[start_col + F12_MUL_BY_014_OFFSET + MULTIPLY_BY_014_Y_CALC_OFFSET + FP6_ADDITION_TOTAL + FP6_SUBTRACTION_TOTAL + (FP_SINGLE_REDUCE_TOTAL + RANGE_CHECK_TOTAL)*j + FP_SINGLE_REDUCED_OFFSET + i])
//             );
//             yield_constr.constraint(
//             bit_selector_val *
//                 next_values[start_col + FIRST_ROW_SELECTOR_OFFSET] *
...
//                 (next_values[start_col + F12_OFFSET + j*12 + i] -
//                 local_values[start_col + F12_SQ_CALC_OFFSET + FP12_MUL_X_CALC_OFFSET + FP6_ADDITION_TOTAL + (FP_SINGLE_REDUCE_TOTAL + RANGE_CHECK_TOTAL)*j + FP_SINGLE_REDUCED_OFFSET + i])
//             );
//             yield_constr.constraint(
//             bit_selector_val *
//                 next_values[start_col + FIRST_ROW_SELECTOR_OFFSET] *
//                 (P::ONES - next_values[start_col + BIT1_SELECTOR_OFFSET]) *
//                 (next_values[start_col + F12_OFFSET + j*12 + i + 24*3] -
//                 local_values[start_col + F12_SQ_CALC_OFFSET + FP12_MUL_Y_CALC_OFFSET + FP6_ADDITION_TOTAL + FP6_SUBTRACTION_TOTAL + (FP_SINGLE_REDUCE_TOTAL + RANGE_CHECK_TOTAL)*j + FP_SINGLE_REDUCED_OFFSET + i])
//             );
//         }
//     }
...
//             (local_values[start_col + O1_CALC_OFFSET + FP2_FP_X_INPUT_OFFSET + i] - local_values[start_col + ELL_COEFFS_OFFSET + 24 + i])
//         );
//         if i < 12 {
//             yield_constr.constraint(
//             bit_selector_val *
//                 local_values[start_col + O1_CALC_OFFSET + FP2_FP_MUL_SELECTOR_OFFSET] *
//                 (local_values[start_col + O1_CALC_OFFSET + FP2_FP_Y_INPUT_OFFSET + i] - local_values[start_col + PX_OFFSET + i])
//             );
//         }
//     }
//     add_fp2_fp_mul_constraints(local_values, next_values, yield_constr, start_col + O1_CALC_OFFSET, bit_selector);
...
//             (local_values[start_col + O4_CALC_OFFSET + FP2_FP_X_INPUT_OFFSET + i] - local_values[start_col + ELL_COEFFS_OFFSET + 48 + i])
//         );
//         if i < 12 {
//             yield_constr.constraint(
//             bit_selector_val *
//                 local_values[start_col + O4_CALC_OFFSET + FP2_FP_MUL_SELECTOR_OFFSET] *
//                 (local_values[start_col + O4_CALC_OFFSET + FP2_FP_Y_INPUT_OFFSET + i] - local_values[start_col + PY_OFFSET + i])
//             );
//         }
//     }
//     add_fp2_fp_mul_constraints(local_values, next_values, yield_constr, start_col + O4_CALC_OFFSET, bit_selector);
...
//                 (local_values[start_col + F12_MUL_BY_014_OFFSET + MULTIPLY_BY_014_INPUT_OFFSET + j*12 + i] -
...
//             bit_selector_val *
//                 local_values[start_col + F12_MUL_BY_014_OFFSET + MULTIPLY_BY_014_SELECTOR_OFFSET] *
//                 (local_values[start_col + F12_MUL_BY_014_OFFSET + MULTIPLY_BY_014_O0_OFFSET + j*12 + i] -
//                 local_values[start_col + ELL_COEFFS_OFFSET + j*12 + i])
//             );
//             yield_constr.constraint(
//             bit_selector_val *
//                 local_values[start_col + F12_MUL_BY_014_OFFSET + MULTIPLY_BY_014_SELECTOR_OFFSET] *
//                 (local_values[start_col + F12_MUL_BY_014_OFFSET + MULTIPLY_BY_014_O1_OFFSET + j*12 + i] -
//                 local_values[start_col + O1_CALC_OFFSET + z_offset + REDUCED_OFFSET + i])
//             );
//             yield_constr.constraint(
//             bit_selector_val *
//                 local_values[start_col + F12_MUL_BY_014_OFFSET + MULTIPLY_BY_014_SELECTOR_OFFSET] *
//                 (local_values[start_col + F12_MUL_BY_014_OFFSET + MULTIPLY_BY_014_O4_OFFSET + j*12 + i] -
//                 local_values[start_col + O4_CALC_OFFSET + z_offset + REDUCED_OFFSET + i])
//             );
//         }
//     }
//     add_multiply_by_014_constraints(local_values, next_values, yield_constr, start_col + F12_MUL_BY_014_OFFSET, bit_selector);
...
//                 local_values[start_col + F12_SQ_CALC_OFFSET + FP12_MUL_SELECTOR_OFFSET] *
//                 (local_values[start_col + F12_MUL_BY_014_OFFSET + MULTIPLY_BY_014_Y_CALC_OFFSET + FP6_ADDITION_TOTAL + FP6_SUBTRACTION_TOTAL + (FP_SINGLE_REDUCE_TOTAL + RANGE_CHECK_TOTAL)*j + FP_SINGLE_REDUCED_OFFSET + i] -
//                 local_values[start_col + F12_SQ_CALC_OFFSET + FP12_MUL_X_INPUT_OFFSET + j*12 + i + 24*3])
//             );
//         }
//         for j in 0..12 {
//             yield_constr.constraint(
...
//         }
//     }
//     add_fp12_multiplication_constraints(local_values, next_values, yield_constr, start_col + F12_SQ_CALC_OFFSET, bit_selector);
...
//                 yield_constr.constraint(
//             bit_selector_val *
//                     local_values[start_col + RES_CONJUGATE_OFFSET + fp2_offset + fp_offset + FP_ADDITION_CHECK_OFFSET] *
//                     (local_values[start_col + RES_CONJUGATE_OFFSET + fp2_offset + fp_offset + FP_ADDITION_X_OFFSET + i] -
//                     local_values[start_col + MILLER_LOOP_RES_OFFSET + (j+3)*24 + k*12 + i])
//                 );
//             }
//         }
//     }
//     add_negate_fp6_constraints(local_values, yield_constr, start_col + RES_CONJUGATE_OFFSET, bit_selector);
...
//                     local_values[start_col + F12_MUL_BY_014_OFFSET + MULTIPLY_BY_014_X_CALC_OFFSET + fp2_add_offset + fp_add_offset + FP_ADDITION_CHECK_OFFSET] *
//                     (local_values[start_col + F12_MUL_BY_014_OFFSET + MULTIPLY_BY_014_X_CALC_OFFSET + FP6_ADDITION_TOTAL + (FP_SINGLE_REDUCE_TOTAL + RANGE_CHECK_TOTAL)*(j*2+k) + FP_SINGLE_REDUCED_OFFSET + i] -
//                     local_values[start_col + MILLER_LOOP_RES_OFFSET + j*24 + k*12 + i])
//                 );
//                 yield_constr.constraint(
//             bit_selector_val *
//                     local_values[start_col + LAST_BIT_SELECTOR_OFFSET] *
//                     local_values[start_col + F12_MUL_BY_014_OFFSET + MULTIPLY_BY_014_Y_CALC_OFFSET + FP6_ADDITION_TOTAL + fp2_sub_offset + fp_sub_offset + FP_SUBTRACTION_CHECK_OFFSET] *
//                     (local_values[start_col + F12_MUL_BY_014_OFFSET + MULTIPLY_BY_014_Y_CALC_OFFSET + FP6_ADDITION_TOTAL + FP6_SUBTRACTION_TOTAL + (FP_SINGLE_REDUCE_TOTAL + RANGE_CHECK_TOTAL)*(j*2+k) + FP_SINGLE_REDUCED_OFFSET + i] -
//                     local_values[start_col + RES_CONJUGATE_OFFSET + fp2_add_offset + fp_add_offset + FP_ADDITION_Y_OFFSET + i])
//                 );
//             }
//         }
//     }
// }
// pub fn add_miller_loop_constraints_ext_circuit<
...
//     for i in 0..12 {
//         let c1 = builder.sub_extension(local_values[start_col + PX_OFFSET + i] , next_values[start_col + PX_OFFSET + i]);
//         let c = builder.mul_extension(bit_selector_val, c1);
//         yield_constr.constraint_transition(builder, c);

//         let c2 = builder.sub_extension(local_values[start_col + PY_OFFSET + i] , next_values[start_col + PY_OFFSET + i]);
...
//             let mul_tmp1 = builder.mul_extension(next_values[start_col + FIRST_ROW_SELECTOR_OFFSET], next_values[start_col + BIT1_SELECTOR_OFFSET]);

//             let sub_tmp1 = builder.sub_extension(next_values[start_col + F12_OFFSET + j*12 + i] , local_values[start_col + F12_MUL_BY_014_OFFSET + MULTIPLY_BY_014_X_CALC_OFFSET + FP6_ADDITION_TOTAL + (FP_SINGLE_REDUCE_TOTAL + RANGE_CHECK_TOTAL)*j + FP_SINGLE_REDUCED_OFFSET + i]);
//             let c1 = builder.mul_extension(sub_tmp1, mul_tmp1);
//             let c = builder.mul_extension(bit_selector_val,c1);
//             yield_constr.constraint(builder,c);

//             let sub_tmp2 = builder.sub_extension(next_values[start_col + F12_OFFSET + j*12 + i + 24*3] , local_values[start_col + F12_MUL_BY_014_OFFSET + MULTIPLY_BY_014_Y_CALC_OFFSET + FP6_ADDITION_TOTAL + FP6_SUBTRACTION_TOTAL + (FP_SINGLE_REDUCE_TOTAL + RANGE_CHECK_TOTAL)*j + FP_SINGLE_REDUCED_OFFSET + i]);
...
//             let sub_tmp4 = builder.sub_extension(next_values[start_col + F12_OFFSET + j*12 + i + 24*3] , local_values[start_col + F12_SQ_CALC_OFFSET + FP12_MUL_Y_CALC_OFFSET + FP6_ADDITION_TOTAL + FP6_SUBTRACTION_TOTAL + (FP_SINGLE_REDUCE_TOTAL + RANGE_CHECK_TOTAL)*j + FP_SINGLE_REDUCED_OFFSET + i]);
...
//         let sub_tmp = builder.sub_extension(local_values[start_col + O1_CALC_OFFSET + FP2_FP_X_INPUT_OFFSET + i] , local_values[start_col + ELL_COEFFS_OFFSET + 24 + i]);
//         let c = builder.mul_extension(sub_tmp, mul_tmp);
//         let c = builder.mul_extension(bit_selector_val, c);
//         yield_constr.constraint(builder,c);
//         if i<12 {
//             let sub_tmp = builder.sub_extension(local_values[start_col + O1_CALC_OFFSET + FP2_FP_Y_INPUT_OFFSET + i] , local_values[start_col + PX_OFFSET + i]);
//             let c = builder.mul_extension(sub_tmp, mul_tmp);
//             let c = builder.mul_extension(bit_selector_val, c);
//             yield_constr.constraint(builder,c);
//         }
//     }
//     add_fp2_fp_mul_constraints_ext_circuit(builder, yield_constr, local_values, next_values, start_col + O1_CALC_OFFSET, bit_selector);

//     // O4
//     for i in 0..24 {
//         let mul_tmp = local_values[start_col + O4_CALC_OFFSET + FP2_FP_MUL_SELECTOR_OFFSET];
//         let sub_tmp = builder.sub_extension(local_values[start_col + O4_CALC_OFFSET + FP2_FP_X_INPUT_OFFSET + i] , local_values[start_col + ELL_COEFFS_OFFSET + 48 + i]);
//         let c = builder.mul_extension(sub_tmp, mul_tmp);
//         let c = builder.mul_extension(bit_selector_val, c);
//         yield_constr.constraint(builder,c);
//         if i < 12 {
//             let sub_tmp = builder.sub_extension(local_values[start_col + O4_CALC_OFFSET + FP2_FP_Y_INPUT_OFFSET + i] , local_values[start_col + PY_OFFSET + i]);
//             let c = builder.mul_extension(sub_tmp, mul_tmp);
//             let c = builder.mul_extension(bit_selector_val, c);
//             yield_constr.constraint(builder,c);
//         }
//     }
//     add_fp2_fp_mul_constraints_ext_circuit(builder, yield_constr, local_values, next_values, start_col + O4_CALC_OFFSET, bit_selector);

//     // f12 multiply by 014
//     for i in 0..12 {
//         let mul_tmp = local_values[start_col + F12_MUL_BY_014_OFFSET + MULTIPLY_BY_014_SELECTOR_OFFSET];
//         for j in 0..12 {
//             let sub_tmp = builder.sub_extension(local_values[start_col + F12_MUL_BY_014_OFFSET + MULTIPLY_BY_014_INPUT_OFFSET + j*12 + i] , local_values[start_col + F12_OFFSET + j*12 + i]);
//             let c = builder.mul_extension(sub_tmp, mul_tmp);
//             let c = builder.mul_extension(bit_selector_val, c);
//             yield_constr.constraint(builder,c);
//         }
...
//             let sub_tmp1 = builder.sub_extension(local_values[start_col + F12_MUL_BY_014_OFFSET + MULTIPLY_BY_014_O0_OFFSET + j*12 + i] , local_values[start_col + ELL_COEFFS_OFFSET + j*12 + i]);
//             let c1 = builder.mul_extension(sub_tmp1, mul_tmp);
//             let c = builder.mul_extension(bit_selector_val, c1);
//             yield_constr.constraint(builder,c);

//             let sub_tmp2 = builder.sub_extension(local_values[start_col + F12_MUL_BY_014_OFFSET + MULTIPLY_BY_014_O1_OFFSET + j*12 + i] , local_values[start_col + O1_CALC_OFFSET + z_offset + REDUCED_OFFSET + i]);
//             let c2 = builder.mul_extension(sub_tmp2, mul_tmp);
//             let c = builder.mul_extension(bit_selector_val, c2);
//             yield_constr.constraint(builder,c);

//             let sub_tmp3 = builder.sub_extension(local_values[start_col + F12_MUL_BY_014_OFFSET + MULTIPLY_BY_014_O4_OFFSET + j*12 + i] , local_values[start_col + O4_CALC_OFFSET + z_offset + REDUCED_OFFSET + i]);
//             let c3 = builder.mul_extension(sub_tmp3, mul_tmp);
//             let c = builder.mul_extension(bit_selector_val,c3);
//             yield_constr.constraint(builder,c);
//         }
//     }
//     add_multiply_by_014_constraints_ext_circuit(builder, yield_constr, local_values, next_values, start_col + F12_MUL_BY_014_OFFSET, bit_selector);
...
//             let sub_tmp1 = builder.sub_extension(local_values[start_col + F12_MUL_BY_014_OFFSET + MULTIPLY_BY_014_X_CALC_OFFSET + FP6_ADDITION_TOTAL + (FP_SINGLE_REDUCE_TOTAL + RANGE_CHECK_TOTAL)*j + FP_SINGLE_REDUCED_OFFSET + i] , local_values[start_col + F12_SQ_CALC_OFFSET + FP12_MUL_X_INPUT_OFFSET + j*12 + i]);
//             let c1 = builder.mul_extension(sub_tmp1, mul_tmp);
//             let c = builder.mul_extension(bit_selector_val, c1);
//             yield_constr.constraint(builder,c);

//             let sub_tmp2 = builder.sub_extension(local_values[start_col + F12_MUL_BY_014_OFFSET + MULTIPLY_BY_014_Y_CALC_OFFSET + FP6_ADDITION_TOTAL + FP6_SUBTRACTION_TOTAL + (FP_SINGLE_REDUCE_TOTAL + RANGE_CHECK_TOTAL)*j + FP_SINGLE_REDUCED_OFFSET + i] , local_values[start_col + F12_SQ_CALC_OFFSET + FP12_MUL_X_INPUT_OFFSET + j*12 + i + 24*3]);
//             let c2 = builder.mul_extension(sub_tmp2, mul_tmp);
//             let c = builder.mul_extension(bit_selector_val, c2);
//             yield_constr.constraint(builder,c);
//         }
//         for j in 0..12 {
//             let c = builder.sub_extension(local_values[start_col + F12_SQ_CALC_OFFSET + FP12_MUL_X_INPUT_OFFSET + j*12 + i] , local_values[start_col + F12_SQ_CALC_OFFSET + FP12_MUL_Y_INPUT_OFFSET + j*12 + i]);
//             let c = builder.mul_extension(bit_selector_val, c);
//             yield_constr.constraint(builder,c);
//         }
//     }
//     add_fp12_multiplication_constraints_ext_circuit(builder, yield_constr, local_values, next_values, start_col + F12_SQ_CALC_OFFSET, bit_selector);
...
//                     FP2_ADDITION_1_OFFSET
//                 };
//                 let sub_tmp = builder.sub_extension(local_values[start_col + RES_CONJUGATE_OFFSET + fp2_offset + fp_offset + FP_ADDITION_X_OFFSET + i] , local_values[start_col + MILLER_LOOP_RES_OFFSET + (j+3)*24 + k*12 + i]);
//                 let c = builder.mul_extension(sub_tmp, local_values[start_col + RES_CONJUGATE_OFFSET + fp2_offset + fp_offset + FP_ADDITION_CHECK_OFFSET]);
//                 let c = builder.mul_extension(bit_selector_val, c);
//                 yield_constr.constraint(builder,c);
//             }
//         }
//     }
//     add_negate_fp6_constraints_ext_circuit(builder, yield_constr, local_values, start_col + RES_CONJUGATE_OFFSET, bit_selector);
...
//                 let mul_tmp1 = builder.mul_extension(local_values[start_col + LAST_BIT_SELECTOR_OFFSET] , local_values[start_col + F12_MUL_BY_014_OFFSET + MULTIPLY_BY_014_X_CALC_OFFSET + fp2_add_offset + fp_add_offset + FP_ADDITION_CHECK_OFFSET]);
//                 let sub_tmp1 = builder.sub_extension(local_values[start_col + F12_MUL_BY_014_OFFSET + MULTIPLY_BY_014_X_CALC_OFFSET + FP6_ADDITION_TOTAL + (FP_SINGLE_REDUCE_TOTAL + RANGE_CHECK_TOTAL)*(j*2+k) + FP_SINGLE_REDUCED_OFFSET + i] , local_values[start_col + MILLER_LOOP_RES_OFFSET + j*24 + k*12 + i]);
//                 let c1 = builder.mul_extension(sub_tmp1, mul_tmp1);
//                 let c = builder.mul_extension(bit_selector_val, c1);
//                 yield_constr.constraint(builder,c);

//                 let mul_tmp2 = builder.mul_extension(local_values[start_col + LAST_BIT_SELECTOR_OFFSET] , local_values[start_col + F12_MUL_BY_014_OFFSET + MULTIPLY_BY_014_Y_CALC_OFFSET + FP6_ADDITION_TOTAL + fp2_sub_offset + fp_sub_offset + FP_SUBTRACTION_CHECK_OFFSET]);
//                 let sub_tmp2 = builder.sub_extension(local_values[start_col + F12_MUL_BY_014_OFFSET + MULTIPLY_BY_014_Y_CALC_OFFSET + FP6_ADDITION_TOTAL + FP6_SUBTRACTION_TOTAL + (FP_SINGLE_REDUCE_TOTAL + RANGE_CHECK_TOTAL)*(j*2+k) + FP_SINGLE_REDUCED_OFFSET + i] , local_values[start_col + RES_CONJUGATE_OFFSET + fp2_add_offset + fp_add_offset + FP_ADDITION_Y_OFFSET + i]);
...
//         for i in 0..12 {
//             yield_constr.constraint(
//                 local_values[PX_OFFSET + i] - public_inputs[PIS_PX_OFFSET + i]
//             );
//             yield_constr.constraint(
//                 local_values[PY_OFFSET + i] - public_inputs[PIS_PY_OFFSET + i]
//             );
//         }
//         for i in 0..68 {
//             for j in 0..24*3 {
...
//                     (local_values[ELL_COEFFS_OFFSET + j] - public_inputs[PIS_ELL_COEFFS_OFFSET + i*24*3 + j])
//                 );
//             }
//         }
//         for i in 0..24*3*2 {
//             yield_constr.constraint(local_values[MILLER_LOOP_RES_OFFSET + i] - public_inputs[PIS_RES_OFFSET + i]);
//         }
...
//         for i in 0..12 {
//             let c1 = builder.sub_extension(local_values[PX_OFFSET + i] , public_inputs[PIS_PX_OFFSET + i]);
//             yield_constr.constraint(builder, c1);

//             let c2 = builder.sub_extension(local_values[PY_OFFSET + i] , public_inputs[PIS_PY_OFFSET + i]);
//             yield_constr.constraint(builder,c2);
//         }
//         for i in 0..68{
//             for j in 0..24*3 {
//                 let sub_tmp = builder.sub_extension(local_values[ELL_COEFFS_OFFSET + j] , public_inputs[PIS_ELL_COEFFS_OFFSET + i*24*3 + j]);
//                 let c = builder.mul_extension( local_values[ELL_COEFFS_INDEX_OFFEST + i], sub_tmp);
//                 yield_constr.constraint(builder, c);
//             }
//         }
//         for i in 0..24*3*2 {
//             let c = builder.sub_extension(local_values[MILLER_LOOP_RES_OFFSET + i] , public_inputs[PIS_RES_OFFSET + i]);
//             yield_constr.constraint(builder, c);
//         }
//         add_miller_loop_constraints_ext_circuit(builder, yield_constr, local_values, next_values, 0, None);
//     }
