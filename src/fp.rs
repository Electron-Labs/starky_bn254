...
// use crate::{native::{add_u32_slices, add_u32_slices_8, get_bits_as_array, get_div_rem_modulus_from_biguint_12, get_selector_bits_from_u32, get_u32_vec_from_literal, get_u32_vec_from_literal_24, modulus, mul_u32_slice_8, multiply_by_slice, sub_u32_slices, sub_u32_slices_8, Fp}, utils::*};
...
//     const D: usize,
//     const C: usize,
// >(trace: &mut Vec<[F; C]>, x: &[u32; 12], row: usize, start_col: usize) {
...
//         yield_constr.constraint(
//             bit_selector_val * local_values[start_col + RANGE_CHECK_SELECTOR_OFFSET] * (val_reconstructed - local_values[start_col + RANGE_CHECK_SUM_OFFSET + 11])
//         );
//         yield_constr.constraint(bit_selector_val * local_values[start_col + RANGE_CHECK_SELECTOR_OFFSET] * local_values[bit_col + 30]);
//     }
// }
